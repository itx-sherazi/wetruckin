    ...
    <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-gray-100 p-6 w-full">
      ...
      <div className="w-full lg:w-1/2 p-8 rounded-2xl">
        <h2 className="text-3xl font-bold text-black mb-6 flex items-center">
          Send Us Message <span className="ml-2">😊</span>
        </h2>
        <form className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block font-semibold text-gray-700">First Name *</label>
              <input type="text" className="w-full border border-blue-600 p-2 rounded-lg focus:ring-2 focus:ring-blue-400" required />
            </div>
            <div>
          ...
          <div>
            ...
            <input type="tel" className="w-full border border-blue-600 p-2 rounded-lg focus:ring-2 focus:ring-blue-400" placeholder="0301 2345678" />
          </div>
          <div>
            <label className="block font-semibold text-gray-700">Email *</label>
            <input type="email" className="w-full border border-blue-600 p-2 rounded-lg focus:ring-2 focus:ring-blue-400" required />
          </div>
          <div>
            <label className="block font-semibold text-gray-700">Message</label>
            <textarea className="w-full border border-blue-600 p-2 rounded-lg focus:ring-2 focus:ring-blue-400" rows="4"></textarea>
          </div>
