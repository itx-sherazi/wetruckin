...
import TrailerOptions from '../Carriers/TrailersOptions';
const FindTruck = () => {
...
<div className="relative w-64" ref={calendarRef}>
    ...
    <input
      type="text"
      className="border border-black px-4 py-2 rounded-lg bg-white text-gray-600 text-sm w-[175px] md:w-[240px] cursor-pointer"
  ...
  <div className="relative w-56" ref={dropdownRef}>
    {/* Input Button */}
    <button
      className="border border-black px-4 py-2 rounded-lg bg-white text-gray-600 text-sm w-[175px] md:w-[240px] text-left"
  ...
  <div className="relative flex-1 md:flex-none">
    <select className="border border-black px-5 py-2 rounded-lg bg-white text-gray-600 text-sm appearance-none w-full pr-8">
  ...
  <div className="relative flex-1 md:flex-none">
    <select className="border border-black px-5 py-2 rounded-lg bg-white text-gray-600 text-sm appearance-none w-full pr-8">
      <option value="any">Length: All</option>
      <option value="option1">Option 1</option>
      <option value="option2">Option 2</option>
      <option value="option3">Option 3</option>
    </select>
...
<div className="flex justify-center items-center  text-center">
  <p className="text-blue-500 text-3xl md:text-4xl lg:text-3xl font-semibold">
