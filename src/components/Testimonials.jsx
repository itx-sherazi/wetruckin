...
const testimonials = [
  {
    name: "Sergey Brin",
    image: "https://wetruckin.com/wp-content/uploads/2023/04/cars-testimon-1-100x100.jpg",
  ...
  {
    name: "Sarah Connor",
    image: "https://wetruckin.com/wp-content/uploads/2023/04/fashion-testimon-2-100x100.jpg",
  ...
  {
    name: "Sarah Connor",
    image: "https://wetruckin.com/wp-content/uploads/2023/04/cars-testimon-3-100x100.jpg",
...
const Testimonials = () => {
  return (
    <section className=" py-12 px-4 md:px-16 pt-20 text-center">
      <div className="max-w-4xl mx-auto">
        <span className="bg-blue-400 text-white text-sm px-4 py-1 uppercase font-semibold">
          Customer Reviews
        </span>
        <h2 className="text-4xl font-semibold mt-4 text-red-600">WHAT OUR CUSTOMERS SAY</h2>
        <p className="mt-2 text-blue-600">
          Our customers are the heart of our business and we are grateful for their loyalty and support
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 mt-10">
        {testimonials.map((testimonial, index) => (
          <div key={index} className="p-6 rounded-lg max-w-sm "
            ...
            <img src={testimonial.image} alt={testimonial.name} className="w-24 h-24 rounded-full mx-auto border-4 border-blue-600" />
            <p className="mt-4 text-red-600 italic">“{testimonial.text}”</p>
