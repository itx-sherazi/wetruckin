  ...
  return (
    <section className="bg-black text-white py-12 px-6 md:px-20">
      <div className="container mx-auto flex flex-col md:flex-row items-center text-center md:text-left">
        ...
        <div
          className={`flex flex-col items-center md:items-start md:w-1/3 pr-40 mb-6 md:mb-0 ${
            isMobile ? "w-full" : ""
          }`}
        >
          <img
            src="https://wetruckin.com/wp-content/uploads/2023/04/w-corp-img-3-opt.png"
            className="w-30 h-30 mb-4"
          />
          <h2 className="text-2xl font-bold">
            Trusted Us for A{" "}
            <span className="text-blue-500">Long Time!</span>
          </h2>
        </div>
          ...
          <div className="md:w-2/3 flex flex-col md:flex-row justify-between space-y-6 md:space-y-0 md:space-x-6">
            <div className="w-full md:w-1/2 lg:w-1/3">
              ...
              <p className="text-gray-400 mt-2">
                At WeTruckin, we build trust with our clients by providing
                reliable and efficient truck dispatching services tailored to meet
            ...
            <div className="w-full md:w-1/2 lg:w-1/3">
              <h3 className="text-xl font-bold">
                Cooperation with{" "}
                <span className="text-blue-500">The Client</span>
              </h3>
              <p className="text-gray-400 mt-2">
                At WeTruckin, we prioritize cooperation with our clients to
                ensure their shipments are delivered on time and according to
